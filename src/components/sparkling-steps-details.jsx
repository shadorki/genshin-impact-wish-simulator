...
export default function SparklingStepsDetails() {
  ...
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>| Event Wish <span className="orange">Sparkling</span> Steps</h1>
        </Title>
        <SubheadingSeparator
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              Event Wish - <span className="orange">Sparkling</span> Steps is now available. During this event wish, the 5-star character <span className="orange">"Fleeing Sunlight" Klee (Pyro)</span> as well as 4-star characters <span className="aqua">"Juvenile Galant" Xingqiu (Hydro)</span>, <span className="brass">"Chivalric Blossom" Noelle (Geo)</span>, and <span className="teal">"Harmless Sweetie" Sucrose (Anemo)</span> will get a <span className="orange">huge drop-rate boost!</span>
            </p>
            <p className="my-3">
              〓Rules〓
            </p>
            ...
            <p className="my-3">
              For Event Wish - <span className="orange">Sparkling</span> Steps: Base probability of winning 5-star character = <span className="orange">0.600%</span>; consolidated probability (incl. guarantee) = <span className="orange">1.600%</span>; guaranteed to win 5-star character at least once per <span className="orange">90</span> attempts. <br/>
            The first time you win a 5-star item in this event wish, there is a <span className="orange">50%</span> chance it will be the promotional character <span className="orange">"Fleeing Sunlight" Klee (Pyro)</span>. If the first 5-star character you win in this event wish is not the promotional character, then the next 5-star character you win is <span className="orange">guaranteed</span> to be the promotional character.
            </p>
            <p className="my-3">
              4-Star Items
            </p>
            <p className="my-3">
              For Event Wish - <span className="orange">Sparkling</span> Steps: Base probability of winning 4-star item = <span className="orange">5.100%</span>; consolidated probability (incl. guarantee) = <span className="orange">13.000%</span>; guaranteed to win 4-star or above item at least once per <span className="orange">10</span> attempts. <br />
              The first time you win a 4-star item in this event wish, there is a <span className="orange">50%</span> chance it will be one of the featured characters <span className="aqua">"Juvenile Galant" Xingqiu (Hydro)</span>, <span className="brass">"Chivalric Blossom" Noelle (Geo)</span>, and <span className="teal">"Harmless Sweetie" Sucrose (Anemo)</span>. If the first 4-star item you win in this event wish is not one of the featured characters, then the next 4-star item you win is <span className="orange">guaranteed</span> to be a featured character.
            </p>
            <p className="my-3">
