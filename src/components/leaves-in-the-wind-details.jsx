  ...
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>
            | Event Wish <span className="teal">Leaves</span> in the Wind
          </h1>
        </Title>
        ...
        />
        <Row>
          <DetailsBox title={"kazuha"} isWeapon={false} element={"wind"} />
        </Row>
        <StarsBar
          starCount={4}
        ...
        <Row>
          ...
          <DetailsBox title={"bennett"} isWeapon={false} element={"pyro"} />
          <DetailsBox title={"razor"} isWeapon={false} element={"electric"} />
        </Row>
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              Event Wish - <span className="teal">Leaves</span> in the Wind is
              now available. During this event wish, the 5-star character{" "}
              <span className="teal">"Scarlet Leaves Pursue Wild Waves" Kaedehara Kazuha (Anemo)</span> as
              well as 4-star characters{" "}
              <span className="aqua">"Thorny Benevolence" Rosaria (Cryo)</span>,{" "}
              <span className="orange">"Trial by Fire" Bennett (Pyro)</span>,
              and{" "}
            ...
            <p className="my-3">
              For Event Wish - <span className="teal">Leaves</span> in the Wind:
              ...
              <span className="teal">"Scarlet Leaves Pursue Wild Waves" Kaedehara Kazuha (Anemo)</span>. If
