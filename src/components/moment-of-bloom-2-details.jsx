...
export default function MomentOfBloom2Details() {
  const moment = new MomentOfBloom2();
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>
            | Event Wish "<span className="orange">Moment Of</span> Bloom"
          </h1>
        </Title>
        ...
        />
        <Row>
          <DetailsBox title={"hu-tao"} isWeapon={false} element={"pyro"} />
        </Row>
        <StarsBar
          starCount={4}
        ...
        />
        <Row>
          <DetailsBox title={"thoma"} isWeapon={false} element={"pyro"} />
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              Event Wish "<span className="orange">Moment Of</span> Bloom" is
              now available. During this event wish, the{" "}
              <span className="orange">event-exclusive</span> 5-star character{" "}
              <span className="orange">"Fragrance in Thaw" Hu Tao (Pyro)</span>{" "}
              as well as 4-star characters{" "}
              <span className="orange">
                {" "}
                "Protector From Afar" Thoma (Pyro)
              </span>
              , <span className="blue">"Kätzlein Cocktail" Diona (Cryo)</span>,
              and <span className="aqua">"Mujina Ninja" Sayu (Anemo)</span> will
              get a <span className="orange">huge drop-rate boost</span>!
              <br />
              <span className="orange">
            ...
            <p className="my-3">
              For Event Wish "<span className="orange">Moment Of</span> Bloom":
              ...
              <span className="orange">"Fragrance in Thaw" Hu Tao (Pyro)</span>.
              If the first 5-star character you win in this event wish is not
              the promotional character, then the next 5-star character you win
              is <span className="orange">guaranteed</span> to be the
              promotional character.
            </p>
            ...
            <p className="my-3">
              ...
              , <span className="blue">"Kätzlein Cocktail" Diona (Cryo)</span>,
              and <span className="aqua">"Mujina Ninja" Sayu (Anemo)</span>. If
              the first 4-star item you win in this event wish is not one of the
