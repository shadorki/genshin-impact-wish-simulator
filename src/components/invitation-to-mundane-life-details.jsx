...
export default function InvitationToMundaneLifeDetails() {
  ...
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>| Event Wish "<span className="blue">Invitation to</span> Mundane Life"</h1>
        </Title>
        <SubheadingSeparator
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              Event Wish "<span className="blue">Invitation to</span> Mundane Life" is now available. During this event wish, the <span className="orange">event-exclusive</span> 5-star character <span className="aqua">"Vigilant Yaksha" Xiao (Anemo)</span> as well as 4-star characters <span className="blue">"Kätzlein Cocktail" Diona (Cryo)</span>, <span className="purple">"Uncrowned Lord of the Ocean" Beidou (Electro)</span>, and <span className="orange">"Blazing Riff" Xinyan (Pyro)</span> will get a <span className="orange">huge drop-rate boost</span>!
              <br/>
            ...
            <p className="my-3">
              For Event Wish "<span className="blue">Invitation to</span> Mundane Life": Base probability of winning 5-star character = <span className="orange">0.600%</span>; consolidated probability (incl. guarantee) = <span className="orange">1.600%</span>; guaranteed to win 5-star character at least once per <span className="orange">90</span> attempts.
              The first time you win a 5-star item in this event wish, there is a <span className="orange">50.000%</span> chance it will be the promotional character <span className="aqua">"Vigilant Yaksha" Xiao (Anemo)</span>. If the first 5-star character you win in this event wish is not the promotional character, then the next 5-star character you win is <span className="orange">guaranteed</span> to be the promotional character.
            </p>
            <p className="my-3">
              4-Star Items
            </p>
            <p className="my-3">
              For Event Wish "<span className="blue">Invitation to</span> Mundane Life": Base probability of winning 4-star item = <span className="orange">5.100%</span>; base probability of winning 4-star character = <span className="orange">2.550%</span>, and base probability of winning 4-star weapon = <span className="orange">2.550%</span>; consolidated probability (incl. guarantee) of winning 4-star item = <span className="orange">13.000%</span>; guaranteed to win 4-star or above item at least once per <span className="orange">10</span> attempts; probability of winning 4-star item through the guarantee = <span className="orange">99.400%</span>, and probability of winning 5-star item through the guarantee = <span className="orange">0.600%</span>. <br />
              The first time you win a 4-star item in this event wish, there is a <span className="orange">50.000%</span> chance it will be one of the featured characters  <span className="blue">"Kätzlein Cocktail" Diona (Cryo)</span>, <span className="purple">"Uncrowned Lord of the Ocean" Beidou (Electro)</span>, and <span className="orange">"Blazing Riff" Xinyan (Pyro)</span>. If the first 4-star item you win in this event wish is not one of the featured characters, then the next 4-star item you win is <span className="orange">guaranteed</span> to be a featured character.
            </p>
            <p className="my-3">
