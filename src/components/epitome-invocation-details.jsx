    ...
    <div className="details pt-5">
      <Container>
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              Event Wish "<span className="orange">Epitome</span> Invocation" is now available. During this event wish, the <span className="orange">event-exclusive</span> 5-star weapons <span className="brass">Summit Shaper (Sword)</span> and <span className="brass">Skyward Atlas (Catalyst) </span> as well as 4-star weapons <span className="purple">Favonius Sword (Sword)</span>, <span className="purple">Favonius Greatsword (Claymore)</span>, <span className="purple">Favonius Lance (Polearm)</span>, <span className="purple">Sacrificial Fragments (Catalyst)</span>, and <span className="purple">The Stringless (Bow)</span> will get a <span className="orange">huge drop-rate boost</span>!
              <br/>
            ...
            <p className="my-3">
              ...
              The first time you win a 5-star weapon in this event, there is a <span className="orange">75%</span> chance it will be one of the promotional weapons <span className="brass">Summit Shaper (Sword)</span> and <span className="brass">Skyward Atlas (Catalyst) </span>. If the first 5-star weapon you win in this event wish is not one of the promotional weapons, then the next 5-star weapon you win is <span className="orange">guaranteed</span> to be a promotional weapon.
            </p>
            <p className="my-3">
              4-Star Items
            </p>
            <p className="my-3">
              ...
              <br/>
              The first time you win a 4-star item in this event wish, there is a <span className="orange">75%</span> chance that it will be one of the featured weapons <span className="purple">Favonius Sword (Sword)</span>, <span className="purple">Favonius Greatsword (Claymore)</span>, <span className="purple">Favonius Lance (Polearm)</span>, <span className="purple">Sacrificial Fragments (Catalyst)</span>, and <span className="purple">The Stringless (Bow)</span>. If the first 4-star item you win in this event wish is not one of the featured weapons, then the next 4-star item you win is <span className="orange">guaranteed</span> to be a featured weapon.
            </p>
            <p className="my-3">
