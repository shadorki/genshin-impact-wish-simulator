  ...
  return (
    <div className="details pt-5">
      <Container>
        <Title>
          <h1>
            | Event Wish "<span className="aqua">The Heron's </span> Court"
          </h1>
        </Title>
        ...
        />
        <Row>
          <DetailsBox title={"ayaka"} isWeapon={false} element={"cryo"} />
        </Row>
        <StarsBar
          starCount={4}
        ...
        />
        <Row>
          <DetailsBox title={"ningguang"} isWeapon={false} element={"geo"} />
          <DetailsBox title={"chongyun"} isWeapon={false} element={"cryo"} />
          <DetailsBox title={"yanfei"} isWeapon={false} element={"pyro"} />
        </Row>
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              Event Wish - <span className="aqua">The Heron's </span> Court is
              now available. During this event wish, the 5-star character{" "}
              <span className="aqua">
                "Frostflake Heron" Kamisato Ayaka (Cryo)
              </span>{" "}
              as well as 4-star characters{" "}
              <span className="brass">"Eclipsing Star" Ningguang (Geo)</span>,{" "}
              <span className="aqua">"Frozen Ardor" Chongyun (Cryo)</span>,
              and <span className="orange">"Wise Innocence" Yanfei (Pyro)</span>{" "}
            ...
            <p className="my-3">
              For Event Wish - <span className="aqua">The Heron's </span> Court:
            ...
            <p className="my-3">
              ...
              <span className="brass">"Eclipsing Star" Ningguang (Geo)</span>,{" "}
              <span className="aqua">"Frozen Ardor" Chongyun (Cryo)</span>,
              and <span className="orange">"Wise Innocence" Yanfei (Pyro)</span>. If
