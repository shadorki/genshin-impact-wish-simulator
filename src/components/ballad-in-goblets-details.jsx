    ...
    <div className="details pt-5">
      <Container>
        ...
        <Row>
          <Col xs="12">
            <p className="my-3">
              Event Wish "<span className="teal">Ballad</span> in Goblets" is now available. During this event wish, the 5-star character <span className="teal">"Windborne Bard" Venti (Anemo)</span> as well as 4-star characters <span className="aqua">"Shining Idol" Barbara (Hydro)</span>, <span className="purple">"Prinzessin der Verurteilung!" Fischl (Electro)</span>, and <span className="orange">"Exquisite Delicacy" Xiangling (Pyro)</span> will get a <span className="orange">huge drop-rate boost</span>!
            </p>
            <p className="my-3">
              〓Rules〓
            </p>
            ...
            <p className="my-3">
              ...
              The first time you win a 4-star item in this event wish, there is a <span className="orange">50%</span> chance it will be one of the featured characters <span className="aqua">"Shining Idol" Barbara (Hydro)</span>, <span className="purple">"Prinzessin der Verurteilung!" Fischl (Electro)</span>, and <span className="orange">"Exquisite Delicacy" Xiangling (Pyro)</span>. If the first 4-star item you win in this event wish is not one of the featured characters, then the next 4-star item you win is <span className="orange">guaranteed</span> to be a featured character.
            </p>
            <p className="my-3">
            ...
            <p className="my-3">
              ※ This is a character event wish. The wish guarantee count is accumulated within this event only and is independent of the guarantee counts of other wishes.
            </p>
